...
# Crear una regla que permita conexiones RDP entrantes
...
resource "azurerm_virtual_machine" "VM_2" {
    ...
    # Parametros de SO
    os_profile {
        computer_name  = "srvwin${var.OS_HOSTNAME}"
        admin_username = "${var.OS_USER}"
